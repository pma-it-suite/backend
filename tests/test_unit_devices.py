...
class TestRegisterDeviceUnit:
    def test_register_device_user_update_fails(self, get_register_request_factory, registered_user):
        # Arrange
    ...
    def test_register_device_device_insert_fails(self, get_register_request_factory, registered_user):
        # Arrange
        request = get_register_request_factory(registered_user.get_id())
